...
> A $proposal(e,v)$ is decided if the $proposal(e,v)$ has been accepted by **a quorum of acceptors**, the quorum intersection requirement is $\forall Q,Q' \in \mathcal Q : Q \bigcap Q' \neq \emptyset$
